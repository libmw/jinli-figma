          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                _buildPurchaseItem('鲈鱼种采购', '江苏淡水鱼种基地', '现场准备'),
                const SizedBox(height: 8),
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 12),
                _buildNegotiationItem('广东海洋鱼种场', '草鱼种 - 10万尾 - ¥0.15/尾', '2023-06-15'),
                const SizedBox(height: 8),
                _buildNegotiationItem('江苏淡水鱼种基地', '鲈鱼种 - 5万尾 - ¥0.25/尾', '2023-06-14'),
              ],
            ),
          ),
          Container(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 8),
            _buildSupplierItem('江苏淡水鱼种基地', '主营: 鲈鱼、黑鱼、鳊鱼'),
            const SizedBox(height: 8),
